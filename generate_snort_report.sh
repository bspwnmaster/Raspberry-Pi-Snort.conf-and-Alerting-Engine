...
wget http://standards-oui.ieee.org/oui/oui.txt  #gets updated manufacturer list for oui.txt
ping -c 6 -b <bip>  #broadcasts ping on network #lightweight alternative to nmap
